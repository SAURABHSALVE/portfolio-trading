...
def lambda_handler(event, context):
  ...
  /* ── POST 06 ───────────────────────────────────────────────────────── */
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Phase 1 — The Ingestion Pipeline' },
      { type: 'p', text: 'Phase 2 — The Retrieval Pipeline' },
      ...
      { type: 'p', text: 'Okay, this one is important to understand. Models don\'t understand text the way we do. They understand vectors — basically numbers, mathematical representations of meaning. So we convert our chunks into vectors, and this conversion is called creating embeddings. You have APIs for this from OpenAI, Hugging Face, and many others.' },
      ...
      { type: 'p', text: 'All those embeddings? We store them in a Vector Database. And that vector database? That becomes our Knowledge Base. The book. The one your AI will refer to.' },
      ...
      { type: 'p', text: 'Then a semantic search happens — the system looks inside our vector database and finds the most relevant chunks that match what the user is asking.' },
      ...
      { type: 'p', text: 'So now you have two things — the context (from retrieval) and the prompt (your instructions to the LLM).' },
      ...
      { type: 'p', text: 'Finally, you give this combined context + prompt to the LLM, and it generates the final answer for the user.' },
      ...
      { type: 'list', items: [
        '1. Naive RAG — The basic version. What we just explained above. Simple ingestion, simple retrieval, done.',
        '2. RAG with Memory — Here you give your RAG system memory. So it remembers previous conversations and context. Makes the responses feel much more human and continuous.',
        '3. Graph RAG — Instead of just storing chunks, you store relationships between data using a knowledge graph. Great for complex, interconnected data where context between topics matters.',
        '4. Agentic RAG — This one\'s powerful. Here the RAG system can take actions, make decisions, call tools, and plan steps on its own. It\'s not just retrieving and answering — it\'s actually acting like an agent.',
      ]},
